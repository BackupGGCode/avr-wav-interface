...
FRESULT Pff::dir_next (	/* FR_OK:Succeeded, FR_NO_FILE:End of table */
	DIR *dj			/* Pointer to directory object */
)
{
	CLUST clst;
...
FRESULT Pff::follow_path (	/* FR_OK(0): successful, !=0: error code */
...
{
	return pf_read(buff, btr, br, (BYTE)0);
}
...
)
{
	...
	*br = 0;
	...
	while (btr)	{									/* Repeat until all data transferred */
		...
		dr = disk_readp(!buff ? 0 : rbuff, fs->dsect, (WORD)(fs->fptr % 512), rcnt, mix);
		if (dr) goto fr_abort;
